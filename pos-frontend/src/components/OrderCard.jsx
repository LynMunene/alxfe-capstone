  ...
  return (
    <div key={key} className="w-[500px] bg-[#262626] p-4 rounded-lg mb-4">
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center justify-between w-[100%]">
          <div className="flex flex-col items-start gap-1">
            ...
            <p className="text-[#ababab] text-sm">Table <FaLongArrowAltRight className="text-[#ababab] ml-2 inline" /></p>
          </div>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <p className="text-[#f5f5f5] text-lg font-semibold">₹{order.billDetails.total.toFixed(2)}</p>
      </div>
    </div>
  );
};
